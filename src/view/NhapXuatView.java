...
public class NhapXuatView extends JFrame {
...
//			public void run() {
//				try {
//					NhapXuatView frame = new NhapXuatView();
...
//		btnHuyTim_xuat.addActionListener(action);
		...
		cardNhapXuat = new JPanel(new BorderLayout());
		cardNhapXuat.add(tabbedPane, BorderLayout.CENTER);
